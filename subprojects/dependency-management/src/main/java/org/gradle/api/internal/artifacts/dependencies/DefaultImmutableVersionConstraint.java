...
public class DefaultImmutableVersionConstraint extends AbstractVersionConstraint implements ImmutableVersionConstraint {
    ...
    public DefaultImmutableVersionConstraint(String preferredVersion,
                                             ...
                                             boolean strong) {
        this(preferredVersion, requiredVersion, strictVersion, rejectedVersions, null, strong);
    }
    ...
    public static ImmutableVersionConstraint of(VersionConstraint versionConstraint) {
        ...
        return new DefaultImmutableVersionConstraint(versionConstraint.getPreferredVersion(), versionConstraint.getRequiredVersion(), versionConstraint.getStrictVersion(), versionConstraint.getRejectedVersions(), versionConstraint.isStrong());
    }
