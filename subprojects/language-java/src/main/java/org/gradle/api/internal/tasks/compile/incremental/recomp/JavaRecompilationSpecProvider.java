...
public class JavaRecompilationSpecProvider implements RecompilationSpecProvider {
    private final SourceFileClassNameConverter sourceFileClassNameConverter;
    private final IncrementalTaskInputs inputs;

    public JavaRecompilationSpecProvider(CompilationSourceDirs sourceDirs, IncrementalTaskInputs inputs) {
        this.sourceFileClassNameConverter = new LocationBasedSourceToNameConverter(sourceDirs, ".java");
        this.inputs = inputs;
    }
